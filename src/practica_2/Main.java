...
import practica_2.Data2.ArchivoProductos;
...
public class Main extends javax.swing.JFrame {
    ...
    public void fillTable () {
        ...
        for (int i = 0; i < productosGuardar.size(); i++) {
            rowData[0] = productosGuardar.get(i).nombre;
            rowData[1] = productosGuardar.get(i).precio;
            rowData[2] = productosGuardar.get(i).peso;
            rowData[3] = productosGuardar.get(i).volumen;
